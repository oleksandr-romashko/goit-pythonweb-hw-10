...
class ContactsRepository:
    """Repository for database operations with contacts"""
    ...
    async def get_contacts_upcoming_birthdays(
        ...
        if end_date.month == start_date.month:
            ...
            stmt = (
                ...
                .where(
                    ...
                    extract("day", Contact.birthdate).between(
        ...
        query_results = await self.db.execute(stmt)
    ...
    async def remove_contact_by_id(self, contact_id: int) -> Optional[Contact]:
